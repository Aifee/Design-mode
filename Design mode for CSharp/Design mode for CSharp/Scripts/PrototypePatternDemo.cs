using Design_mode_for_CSharp.Scripts.Prototype_Pattern;
using System;
...
namespace Design_mode_for_CSharp.Scripts
{
    ...
    public class PrototypePatternDemo
    {
        public PrototypePatternDemo()
        {
            ...
            Shape clonedShape2 = ShapeCache.getShape<Square>("2");
            Console.WriteLine("Shape : " + clonedShape2.getType());

            //Shape clonedShape3 = (Shape)ShapeCache.getShape("3");
            Shape clonedShape3 = ShapeCache.getShape<Rectangle>("3");
